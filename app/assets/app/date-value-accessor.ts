/**
 * Solution provided by Johannes Hoppe
...
export class DateValueAccessor implements ControlValueAccessor {
  ...
  public constructor(private _renderer: Renderer, private _elementRef: ElementRef) { }

  // tslint:disable-next-line:no-empty
  @HostListener('input', ['$event.target.valueAsDate']) public onChange = (_: any) => { };
  // tslint:disable-next-line:no-empty
